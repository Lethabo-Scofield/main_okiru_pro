...
export default function HubLanding() {
  ...
  const colorMap: Record<string, { icon: string; tag: string; tagBg: string; tagBorder: string; dot: string; glow: string; gradient: string; cardBorder: string; feature: string }> = {
    purple:  { icon: 'text-indigo-400',  tag: 'text-indigo-400',  tagBg: 'bg-indigo-500/10',  tagBorder: 'border-indigo-500/20', dot: 'bg-indigo-400',  glow: 'hover:shadow-indigo-500/8',  gradient: 'from-indigo-500/12 to-slate-500/5',  cardBorder: 'border-indigo-500/15 hover:border-indigo-500/30', feature: 'bg-indigo-400' },
    ...
    <div className="font-sans min-h-screen bg-black" style={{ letterSpacing: '-0.011em', color: '#f5f5f7' }}>
        ...
        <div className="max-w-[1400px] mx-auto w-full px-6 py-3 bg-black" style={{ borderBottom: '1px solid #2c2c2e' }}>
          <div className="relative max-w-lg mx-auto">
            ...
            <input
              ...
              autoFocus
              className="w-full rounded-2xl bg-[#1c1c1e] border border-[#2c2c2e] hover:border-[#3a3a3c] pl-11 pr-10 py-3 text-[14px] text-white outline-none focus:ring-2 focus:ring-white/[0.15] smooth placeholder:text-[#636366]"
              value={searchQuery}
      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="text-center max-w-2xl mx-auto mb-12 fade-in">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/[0.12] bg-white/[0.06] text-[#d1d1d6] text-[11px] font-semibold tracking-wider uppercase mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-[#a0a0a5] animate-pulse"></span>
          ...
          <h1 className="text-[36px] leading-[1.1] sm:text-[44px] font-bold tracking-tight text-white mb-4">
            Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300/80 via-emerald-300/80 to-blue-300/80">Intelligent</span><br />Compliance Command Centre
          </h1>
          ...
          <div className="flex justify-center gap-0 rounded-2xl bg-[#1c1c1e] border border-[#2c2c2e] overflow-hidden max-w-lg mx-auto mb-8">
            {[
              { value: '6', label: 'Toolkits', color: 'text-[#d1d1d6]' },
        ...
        <section className="max-w-4xl mx-auto mb-12 fade-in stagger-1">
          <div className="rounded-2xl bg-[#1c1c1e] border border-emerald-500/20 p-6 flex flex-col sm:flex-row items-center gap-5 relative overflow-hidden">
            ...
            <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-white/[0.05] border border-emerald-500/25 flex items-center justify-center shrink-0 relative z-10">
        ...
        <section className="fade-in stagger-2">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-[13px] font-semibold text-[#98989f] uppercase tracking-wider">
              All Toolkits — <span className="text-[#d1d1d6]">{filteredToolkits.length} modules</span>
            </h2>
          </div>
                ...
                <>
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="pt-4 border-t border-[#2c2c2e] flex items-center justify-between">
                      ...
                      <div className={`w-8 h-8 rounded-full border flex items-center justify-center transition-colors duration-300 ${isActive ? `border-white/[0.12] text-[#d1d1d6] group-hover:bg-white/[0.18]/10` : 'border-[#2c2c2e] text-[#48484a] group-hover:border-[#3a3a3c]'}`}>
