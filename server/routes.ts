...
export async function registerRoutes(
  ...
  app.get("/api/templates", requireAuth, async (req, res) => {
    try {
      const userId = (req.session as any).userId;
      let templates = await storage.getTemplatesByUser(userId);

      // Auto-seed the 6 B-BBEE pillar templates when a user has none
      if (templates.length === 0) {
        const SEED_TEMPLATES = [
          {
            name: "Ownership Verification",
            description: "Extract shareholder ownership, voting rights, and black economic interest from ownership schedules.",
            version: "1.0",
            entities: [
              { label: "BlackVotingRights", definition: "Percentage of voting rights held by black people", zones: ["Ownership", "Shareholding"] },
              { label: "BlackEconomicInterest", definition: "Percentage of economic interest held by black people", zones: ["Ownership", "Shareholding"] },
              { label: "BlackWomenVotingRights", definition: "Percentage of voting rights held by black women", zones: ["Ownership"] },
              { label: "BlackWomenEconomicInterest", definition: "Percentage of economic interest held by black women", zones: ["Ownership"] },
              { label: "TotalBlackOwnership", definition: "Overall black ownership percentage", zones: ["Ownership", "Summary"] },
            ],
          },
          {
            name: "Management Control",
            description: "Extract board, executive and senior management representation by race and gender.",
            version: "1.0",
            entities: [
              { label: "BlackBoardMembers", definition: "Percentage of black board members", zones: ["Board", "Management"] },
              { label: "BlackExecutiveManagement", definition: "Percentage of black executive management", zones: ["Executive", "Management"] },
              { label: "BlackSeniorManagement", definition: "Percentage of black senior management", zones: ["Management"] },
              { label: "BlackMiddleManagement", definition: "Percentage of black middle management", zones: ["Management"] },
              { label: "BlackJuniorManagement", definition: "Percentage of black junior management", zones: ["Management"] },
            ],
          },
          {
            name: "Skills Development",
            description: "Extract training spend on black employees, learnerships, and bursaries.",
            version: "1.0",
            entities: [
              { label: "BlackSkillsSpend", definition: "Total training spend on black people (R value)", zones: ["Skills", "Training"] },
              { label: "LeviableAmount", definition: "Total leviable amount (1% of payroll)", zones: ["Financials", "Skills"] },
              { label: "BlackLearnerships", definition: "Number of black learnership participants", zones: ["Skills", "Training"] },
              { label: "BlackBursaries", definition: "Number of black bursary recipients", zones: ["Skills", "Training"] },
              { label: "SkillsSpendPercent", definition: "Skills spend as percentage of leviable amount", zones: ["Skills", "Summary"] },
            ],
          },
          {
            name: "Preferential Procurement",
            description: "Extract total measured procurement spend, supplier BEE levels and B-BBEE recognised spend.",
            version: "1.0",
            entities: [
              { label: "TMPS", definition: "Total Measured Procurement Spend", zones: ["Procurement", "Financials"] },
              { label: "RecognisedSpend", definition: "B-BBEE recognised procurement spend", zones: ["Procurement"] },
              { label: "EMESupplierSpend", definition: "Procurement spend with EME/QSE suppliers", zones: ["Procurement"] },
              { label: "Level1To4Spend", definition: "Procurement spend with Level 1-4 B-BBEE suppliers", zones: ["Procurement"] },
              { label: "BlackOwnedSupplierSpend", definition: "Spend with 51%+ black-owned suppliers", zones: ["Procurement"] },
            ],
          },
          {
            name: "Enterprise & Supplier Development",
            description: "Extract ESD contributions, beneficiary details, and supplier development amounts.",
            version: "1.0",
            entities: [
              { label: "ESDContributions", definition: "Total enterprise and supplier development contributions (R value)", zones: ["ESD"] },
              { label: "SupplierDevelopmentContribs", definition: "Supplier development contributions only", zones: ["ESD"] },
              { label: "EnterpriseDevelopmentContribs", definition: "Enterprise development contributions only", zones: ["ESD"] },
              { label: "NPAT", definition: "Net profit after tax", zones: ["Financials"] },
              { label: "ESDTarget", definition: "ESD target (3% of NPAT)", zones: ["ESD", "Summary"] },
            ],
          },
          {
            name: "Socio-Economic Development",
            description: "Extract SED contributions, beneficiaries, and community investment details.",
            version: "1.0",
            entities: [
              { label: "SEDContributions", definition: "Total socio-economic development contributions (R value)", zones: ["SED"] },
              { label: "SEDTarget", definition: "SED target (1% of NPAT)", zones: ["SED", "Summary"] },
              { label: "SEDBeneficiaries", definition: "Number of SED beneficiaries", zones: ["SED"] },
              { label: "SEDNonProfitOrgs", definition: "Non-profit organisations supported", zones: ["SED"] },
              { label: "SEDRecognisedSpend", definition: "Recognised SED spend amount", zones: ["SED"] },
            ],
          },
        ];
        ...
        for (const t of SEED_TEMPLATES) {
          try {
            await storage.createTemplate({ ...t, userId });
